...
let {name, phonenumber, email} = inputdata;
    ...
    <h1 style={{ color: darkMode ? "white" : "" }}>
      ...
      />
          ...
          <label style={{ color: darkMode ? "white" : "" }}><b>Please fill in Contact Information Form: </b></label>
           <label style={{ color: darkMode ? "white" : "" }} ><b>Name: </b></label>
            <input
                type="text"
                autoComplete='off'
                name='name'
           ...
           <label style={{ color: darkMode ? "white" : "" }}><b>Phone Number: </b></label>
            <input
                type="text"
                autoComplete='off'
                name='phonenumber'
            ...
            <label style={{ color: darkMode ? "white" : "" }}><b>Email: </b></label>
            <input
                type="text"
                autoComplete='off'
                name='email'
